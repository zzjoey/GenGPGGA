...
def GUI():
    ...
    def check_input():
        ...
        if ((v1_lati_N.get() == '') & (v2_lati_S.get() == '')):
            ...
            if v1_latiN_input_int not in range(0, 90):
            ...
            if v1_latiN_input_int not in range(0, 90):
                tkBox.showwarning("Latitude Error", "纬度范围为 0 ~ 90")
            elif v2_latiS_input_int not in range(0, 90):
                tkBox.showwarning("Latitude Error", "纬度范围为 0 ~ 90")
            else:
        ...
        if ((v3_longi_W.get() == '') & (v4_longi_E.get() == '')):
            ...
            if v4_longiE_input_int not in range(0, 180):
                tkBox.showwarning("Longitude Error", "经度范围为 0 ~ 180")
            else:
            ...
            if v3_longiW_input_int not in range(0, 180):
                ...
                temp_longi1 = random.randrange(0, v3_longiW_input)
                temp_longiHemi1 = 'N'
                temp_longi2 = random.randrange(0, v4_longiE_input)
                temp_longiHemi2 = 'S'
