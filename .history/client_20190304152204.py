...
def GUI():
    ...
    # 经度范围输入
    tk.Label(window, text="经度范围 °W").place(x=50, y=200)
    tk.Entry(window, textvariable=v3_longi_W).place(x=200, y=200)
    tk.Label(window, text="  0°").place(x=400, y=200)
    tk.Entry(window, textvariable=v4_longi_E).place(x=450, y=200)
    tk.Label(window, text="经度范围 °E").place(x=650, y=200)

    # 高度范围输入
    tk.Label(window, text="高度范围 °W").place(x=50, y=300)
    tk.Entry(window, textvariable=v3_longi_W).place(x=200, y=300)
    tk.Label(window, text="  0°").place(x=400, y=300)
    tk.Entry(window, textvariable=v4_longi_E).place(x=450, y=300)
    tk.Label(window, text="经度范围 °E").place(x=650, y=300)
