...
def GUI():
    ...
    tk.Entry(window, textvariable=v1_lati_N).place(x=350, y=150)

    # 经度范围输入
    tk.Label(window, text="经度范围 °N").place(x=100, y=200)
    tk.Entry(window, textvariable=v1_lati_N).place(x=200, y=200)
    tk.Entry(window, textvariable=v1_lati_N).place(x=400, y=200)
