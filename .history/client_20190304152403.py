...
def GUI():
    ...
    # 高度范围输入
    tk.Label(window, text="海拔高度 -/m").place(x=50, y=300)
    tk.Entry(window, textvariable=v5_alti_P).place(x=200, y=300)
    # tk.Label(window, text="  ").place(x=400, y=300)
    tk.Entry(window, textvariable=v6_alti_N).place(x=450, y=300)
    tk.Label(window, text="海拔高度 +/m").place(x=650, y=300)
