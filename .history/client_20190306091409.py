...
def GUI():
    ...
    def check_input():
        ...
        if ((v1_lati_N.get() == '') & (v2_lati_S.get() == '')):
            ...
            if v2_latiS_input_int not in range(0, 90):
                tkBox.showwarning("Latitude Error", "纬度范围为 0 ~ 90")
            else:
        ...
        if ((v3_longi_W.get() == '') & (v4_longi_E.get() == '')):
            ...
            if int(v4_longi_E.get()) not in range(0, 181):
                ...
                final_longiHemi = 'N'
        # elif ((v3_longi_W.get() == '') & (v4_longi_E.get() != '')):
        #     # print(v4_longi_E.get())
        #     if v4_longiE_input_int not in range(0, 181):
        #         tkBox.showwarning("Longitude Error", "经度范围为 0 ~ 180")
        #     else:
        #         final_longi = get_longi(v4_longiE_input_int)
        #         final_longiHemi = 'S'
            ...
            if v3_longiW_input_int not in range(0, 180):
                tkBox.showwarning("Longitude Error", "经度范围为 0 ~ 180")
            elif v4_longiE_input_int not in range(0, 180):
                tkBox.showwarning("Longitude Error", "经度范围为 0 ~ 180")
            else:
                ...
                if (final_longi == temp_longi1):
                    ...
                    final_longiHemi = 'S'
        print(v1_latiN_input_int)
        print(v2_latiS_input_int)
        print(v3_longiW_input_int)
        print(v4_longiE_input_int)
