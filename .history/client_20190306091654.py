        ...
        if ((v3_longi_W.get() == '') & (v4_longi_E.get() == '')):
            ...
            if v3_longiW_input_int not in range(0, 181):
                ...
                if (final_longi == temp_longi1):
                    ...
                    final_longiHemi = 'S'
        if (v1_latiN_input_int not in range(0,91) or v1_latiN_input_int not in range(0,91) or v1_latiN_input_int not in range(0,91) or v1_latiN_input_int not in range(0,91))
